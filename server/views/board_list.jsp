...
<body>
	...
	<nav class="navbar navbar-default navbar-expand-sm navbar-dark bg-primary">
		<a class="navbar-brand" href="#">
			<img class="d-inline-block align-center" src="<spring:url value='/css/images/testlogo.png'/>" width="36" height="36"/>
			게시판
		</a>
		...
		<div class="collapse navbar-collapse" id="#navbarSupportedContent">
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<!-- <li class="dropdown">
					<a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">회원관리
						<span class="caret"></span>
					</a>
					<div class="dropdown-menu">
